<main class="min-h-screen bg-[#f9fafc] pt-[74px]">
	<section class="grid mx-auto w-full max-w-screen-xl p-5 gap-5">
		...
		<div class="grid grid-cols-12 gap-4">
			@foreach ($instrumens as $instrumen)
				<a href="{{ route('survey.detail', $instrumen->id) }}" class="flex cursor-pointer flex-col gap-x-4 gap-y-2 rounded-lg border border-slate-100 bg-white p-8 shadow-sm transition-colors hover:border-color-info-500 lg:col-span-4">
